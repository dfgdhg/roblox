...
local Settings = {
    Team1 = {
        Box = {Enabled = true, Filled = false, Outline = true, Color = Color3.fromRGB(255, 51, 51), OutlineColor = Color3.fromRGB(0, 0, 0), Thickness = 2, Transparency = 1},
        ...
        Distance = {Enabled = false, Size = 13, Center = true, Outline = true, Color = Color3.fromRGB(0, 181, 21), OutlineColor = Color3.fromRGB(0, 0, 0)}
    },
    Team2 = {
        Box = {Enabled = true, Filled = false, Outline = true, Color = Color3.fromRGB(51, 255, 51), OutlineColor = Color3.fromRGB(0, 0, 0), Thickness = 1, Transparency = 1},
        ...
        Distance = {Enabled = false, Size = 13, Center = true, Outline = true, Color = Color3.fromRGB(0, 181, 201), OutlineColor = Color3.fromRGB(0, 0, 0)}
    }
}
